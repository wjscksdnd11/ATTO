...
public class DetailTradeViewHolder extends RecyclerView.ViewHolder {
	...
	void onContainerClicked() {
		...
		Toast.makeText(mContext, "id : " + negoDataList.get(position).getNegotiation_id(), Toast.LENGTH_SHORT).show();
		Intent intent = new Intent(mContext, DetailNegoActivity.class);
		intent.putExtra("Nego_Id", negoDataList.get(position).getNegotiation_id());
